          ...
          <ul className="nav nav-pills mb-2 d-flex flex-wrap justify-content-start" id="pills-tab" role="tablist">
              <li className="nav-item col-6 col-lg-auto pe-2 pe-lg-0 pb-2" role="presentation">
                  <button 
                      ...
                      onClick={() => handleTabClick('sport', 'pills-home-tab')}
                      >運動保健</button>
              </li>
              <li className="nav-item col-6 col-lg-auto ps-2 pe-lg-2" role="presentation">
                  <button 
                      ...
                      onClick={() => handleTabClick('mind', 'pills-mind-tab')}
                      >心理成長</button>
              </li>
              ...
              <button 
                      ...
                      onClick={() => handleTabClick('skills', 'pills-skills-tab')}
                      >生活技能</button>
              </li>
              ...
              <button 
                      ...
                      onClick={() => handleTabClick('community', 'pills-community-tab')}
                      >社區活動</button>
              </li>
          </ul>
